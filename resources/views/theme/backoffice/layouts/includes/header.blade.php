        ...
        <div class="nav-wrapper">
            ...
            <li>
                ...
                <a href="index.html" class="brand-logo darken-1">
                    <img src="{{ asset('assets/backoffice/images/logo/materialize-logo.png') }}" alt="materialize logo">
            ...
            <li>
                ...
                <span class="avatar-status avatar-online">
                    <img src="{{ asset('assets/backoffice/images/avatar/avatar-7.png') }}" alt="avatar">
                    <i></i>
                </span>
                </a>
            </li>
            ...
            <ul id="translation-dropdown" class="dropdown-content">
                <li>
                    <a href="#!" class="grey-text text-darken-1">
                        <i class="flag-icon flag-icon-co"></i> Español</a>
                    </li>
            <li>
                <a href="#!" class="grey-text text-darken-1">

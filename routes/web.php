...
Route::group(['middleware'=> ['auth'], 'as' => 'backoffice.'], function(){
    ...
    Route::post('patient/store_back_schedule', 'PatientController@store_back_schedule')->name('patient.store_back_schedule');
    ...
    Route::get('patient/{user}/appointment/{appointment}/edit', 'PatientController@back_appointment_edit')->name('patient.appointment.edit');
    Route::post('patient/{user}/appointment/{appointment}/update', 'PatientController@back_appointment_update')->name('patient.appointment.update');
